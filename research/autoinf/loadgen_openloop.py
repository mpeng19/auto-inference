"""Open-loop trace replay, including the multiprocess sharded driver.

Retired from the product 2026-09-01. Open-loop arrival is the right model
for scheduler stress work -- it converts overload into queueing rather
than into slowdown -- but the marketplace question is "how many
conversations can we hold", which is closed-loop by construction.
"""
from __future__ import annotations

import asyncio, json, multiprocessing as mp, os, random, time
from simulator.measure.metrics import RequestResult
